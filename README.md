...
```
wget -N [https://raw.githubusercontent.com/xigua761/XrayR-release/master/install.sh && bash install.sh](https://raw.githubusercontent.com/xigua761/XrayR/refs/heads/master/install.sh)
```
